...
public class NetworkTablesWriter implements AutoCloseable, LogWriterLowLevel {
  ...
  private final Map<String, BooleanArrayPublisher> booleanArrayPublishers = new ConcurrentHashMap<>();
  ...
  private final Map<String, IntegerArrayPublisher> integerArrayPublishers = new ConcurrentHashMap<>();
  ...
  private final Map<String, StructArrayPublisher<?>> structArrayPublishers = new ConcurrentHashMap<>();
